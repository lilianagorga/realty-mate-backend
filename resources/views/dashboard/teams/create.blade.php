...
@section('dashboard-content')
    <div class="container mx-auto p-4">
        ...
        <h1 class="text-4xl font-bold text-green-600 text-center">Create Team</h1>
        <form action="{{ route('dashboard.teams.store') }}" method="POST" enctype="multipart/form-data" class="mt-4 max-w-lg mx-auto">
            @csrf
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="address" id="address" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50 bg-beige-200 text-green-700 text-center">
            </div>
            <div class="form-group mb-4">
                <label for="list" class="block text-sm font-medium text-beige-600">List</label>
                <input type="number" name="list" id="list" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50 bg-beige-200 text-green-700 text-center">
            </div>
